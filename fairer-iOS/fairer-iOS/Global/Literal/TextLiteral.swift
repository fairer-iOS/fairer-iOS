...
enum TextLiteral {
    ...
    // MARK: - CreateHouseWorkViewController
    
    static let createHouseWorkViewControllerInfoLabel = "공간을 선택하면 세부 집안일이 나옵니다."
    static let createHouseWorkViewControllerNextButtonText = "다음"
}
